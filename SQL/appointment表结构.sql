CREATE DATABASE IF NOT EXISTS `appointment_cmn` CHARACTER SET utf8;
USE `appointment_cmn`;
...
#
# Database "appointment_hosp"
#

CREATE DATABASE IF NOT EXISTS `appointment_hosp` CHARACTER SET utf8mb4;
USE `appointment_hosp`;
...
#
# Database "appointment_order"
#

CREATE DATABASE IF NOT EXISTS `appointment_order` CHARACTER SET utf8;
USE `appointment_order`;
...
#
# Database "appointment_user"
#

CREATE DATABASE IF NOT EXISTS `appointment_user` CHARACTER SET utf8;
USE `appointment_user`;
